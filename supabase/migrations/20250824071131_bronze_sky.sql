...
BEGIN
  ...
  FOR table_name IN VALUES 
    ('roles'), ('profiles'), ('members'), ('availability'), ('consultations'), 
    ('cults'), ('product_categories'), ('products'), ('orders'), ('order_items'), 
    ('message_templates'), ('messages'), ('blog_posts'), ('system_settings'), 
    ('faqs'), ('form_submissions'), ('donations')
  LOOP
...
-- =====================================================
-- 2. POLÍTICAS PARA ROLES (SUPER ADMIN ONLY)
-- =====================================================
...
BEGIN
  ...
  IF rls_active_count = total_tables AND policy_count > 30 AND function_count = 4 THEN
    RAISE NOTICE '';
