/*
  ...
  toda a estrutura necessária para o sistema funcionar.
...
-- =====================================================
-- 14. CONCEDER PERMISSÕES BÁSICAS
-- =====================================================
...
BEGIN
  ...
  RAISE NOTICE '';
  RAISE NOTICE '🏛️ TEMPLO DE KIMBANDA DRAGÃO NEGRO - RESET COMPLETO';
  RAISE NOTICE '====================================================';
...
SELECT 'RESET COMPLETO EXECUTADO - ESTRUTURA CRIADA COM SUCESSO!' as result;